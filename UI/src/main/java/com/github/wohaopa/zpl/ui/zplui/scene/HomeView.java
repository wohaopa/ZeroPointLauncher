            ...
            var anchorPane = new AnchorPane();
            {
                var nodesList = new JFXNodesList();
                {
                    var more = new JFXButton();
                    {
                        ...
                        var img = new SVGGlyph("M448 448V192h128v256h256v128H576v256H448V576H192V448h256z m64 576A512 512 0 1 1 512 0a512 512 0 0 1 0 1024z m3.008-92.992a416 416 0 1 0 0-832 416 416 0 0 0 0 832z", Color.WHITE);
                        img.setSize(18, 18);
                        more.setGraphic(img);
